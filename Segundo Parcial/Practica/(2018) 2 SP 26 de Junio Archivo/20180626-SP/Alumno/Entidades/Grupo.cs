    ...
    public class Grupo : IEntradaSalida<Grupo>
    {
        ...
        public static Grupo operator +(Grupo g, Equipo e)
        {
            if (g.equipos.Count < g.maxCantidad)
                ...
                throw new GrupoLlenoException(String.Format("El Grupo {0} ya cuenta con {1}equipos",g.grupo,g.maxCantidad));
        ...
        public string Letra
        {
            get { return this.grupo.ToString(); }
        }
        ...
        public Grupo Leer()
        {
            equipos = GrupoDAO.ObtieneEquiposDelGrupo(this.grupo);
            return this;
        }
